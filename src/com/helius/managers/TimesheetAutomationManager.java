...
public class TimesheetAutomationManager {
	...
	public Status sendTimesheetAutomationmail(String clientjson,MultipartHttpServletRequest request) {

		try {
			automationTimesheetDAO.sendTimesheetAutomationmail(clientjson, request);
		} catch (Throwable e) {
			return new Status(false, "Timesheet Automation Mail triggred failed ..! " + e.getMessage());
		}
		return new Status(true, "Timesheet Automation Mail triggred Successfully");
